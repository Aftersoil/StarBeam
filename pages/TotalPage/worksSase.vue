      ...
      <div id="modules">
        ...
        <template v-for="(item, index) in dataList">
          <div id="container1" :key="index">
            ...
            <b-button variant="outline-dark" class="moreInfo">查看更多</b-button>
            <!-- 视频跳转区域 -->
          </div>
        </template>
  ...
  data() {
    return {
      ...
      obj: {
        ...
        modules2: {
          bimg:
            "http://17360474.s61i.faiusr.com/2/AD0I2syjCBACGAAgicnT2wUo55nSogUwgA84_QU.jpg",
          // 二分支标题
          hfour: "超越预期 做到你想不到",
          // 二分支文本
          pcontent:
            "通过研究商业模式来定义品牌模式提供优秀的品牌整合解决方案，令品牌长远发展，更具竞争力新成立企业，需要有好的标志，好的品牌形象有助于提升企业整体竞争力。",
          // 二分支列表
          lis: {
            data1: "· span企业/品牌命名设计",
            data2: "· 企业/品牌标志(logo)设计",
            data3: "· 识别系统(VIS)设计",
            data4: "· 视觉导向系统设计",
            data5: "· 旧品牌优化升级更新设计",
            data6: "· 卡通形象设计",
...
header::before {
  ...
  left: 0;
  right: 0;
  background-image: url("~assets/img/testImg/parallaximg2.jpg");
